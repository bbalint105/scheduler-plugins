...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NicePodArgs)(nil), (*config.NicePodArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NicePodArgs_To_config_NicePodArgs(a.(*NicePodArgs), b.(*config.NicePodArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NicePodArgs)(nil), (*NicePodArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NicePodArgs_To_v1_NicePodArgs(a.(*config.NicePodArgs), b.(*NicePodArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_NicePodArgs_To_config_NicePodArgs(in *NicePodArgs, out *config.NicePodArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.WhatIsNice, &out.WhatIsNice, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_NicePodArgs_To_config_NicePodArgs is an autogenerated conversion function.
func Convert_v1_NicePodArgs_To_config_NicePodArgs(in *NicePodArgs, out *config.NicePodArgs, s conversion.Scope) error {
	return autoConvert_v1_NicePodArgs_To_config_NicePodArgs(in, out, s)
}

func autoConvert_config_NicePodArgs_To_v1_NicePodArgs(in *config.NicePodArgs, out *NicePodArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.WhatIsNice, &out.WhatIsNice, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_NicePodArgs_To_v1_NicePodArgs is an autogenerated conversion function.
func Convert_config_NicePodArgs_To_v1_NicePodArgs(in *config.NicePodArgs, out *NicePodArgs, s conversion.Scope) error {
	return autoConvert_config_NicePodArgs_To_v1_NicePodArgs(in, out, s)
}
