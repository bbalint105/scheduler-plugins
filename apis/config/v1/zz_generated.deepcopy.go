...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NicePodArgs) DeepCopyInto(out *NicePodArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.WhatIsNice != nil {
		in, out := &in.WhatIsNice, &out.WhatIsNice
		*out = new(string)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NicePodArgs.
func (in *NicePodArgs) DeepCopy() *NicePodArgs {
	if in == nil {
		return nil
	}
	out := new(NicePodArgs)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NicePodArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
